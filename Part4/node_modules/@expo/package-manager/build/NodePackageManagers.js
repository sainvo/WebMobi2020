...
class YarnPackageManager {
    ...
    withOfflineSupportAsync(...args) {
        return __awaiter(this, void 0, void 0, function* () {
            if (yield isYarnOfflineAsync_1.default()) {
                args.push('--offline');
            }
    ...
    installAsync() {
        return __awaiter(this, void 0, void 0, function* () {
            const args = yield this.withOfflineSupportAsync('install');
            yield this._runAsync(args);
        });
    }
    addAsync(...names) {
        return __awaiter(this, void 0, void 0, function* () {
            if (!names.length)
                return this.installAsync();
            const args = yield this.withOfflineSupportAsync('add');
            args.push(...names);
            yield this._runAsync(args);
        });
    }
    addDevAsync(...names) {
        return __awaiter(this, void 0, void 0, function* () {
            if (!names.length)
                return this.installAsync();
            const args = yield this.withOfflineSupportAsync('add', '--dev');
            args.push(...names);
            yield this._runAsync(args);
        });
    }
