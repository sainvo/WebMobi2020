 ...
 */
function modifyConfigAsync(projectRoot, modifications, readOptions = {}, writeOptions = {}) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (config.dynamicConfigPath) {
            ...
            */
            ...
            if (!writeOptions.dryRun) {
                yield json_file_1.default.writeAsync(config.staticConfigPath, outputConfig, { json5: false });
            }
...
function writeConfigJsonAsync(projectRoot, options) {
    return __awaiter(this, void 0, void 0, function* () {
        const paths = getConfigFilePaths(projectRoot);
        let { exp, pkg, rootConfig, dynamicConfigObjectType, staticConfigPath, } = yield readConfigJsonAsync(projectRoot);
